...
<div class="page-header">
    <div class="page-title">
        <h4>Barang Masuk</h4>
        <span>Atur barang masuk</span>
    </div>
    <div class="page-btn">
        <a href="/barangmasuk/tambah" class="btn btn-added">
            <img src="<?php echo base_url() ?>/assets/img/icons/plus.svg" class="me-1" alt="img">Tambah Barang Masuk
        </a>
    </div>
</div>
