...
<div class="card">
    <div class="card-body">
        <form action="/barang/ubah" method="post" enctype="multipart/form-data">
            <?php csrf_field() ?>
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" name="barangname" autofocus class="form-control <?= (isset($validation) ? ($validation->getError("barangname") ? "is-invalid" : "") : ""); ?>" value="<?= (isset($barang) ? $barang->barangname : (isset($validation) ? ($validation->hasError("barangname") ? "" : $_POST["barangname"]) : ""));  ?>">
                        <div id="validationServer04Feedback" class="invalid-feedback">
