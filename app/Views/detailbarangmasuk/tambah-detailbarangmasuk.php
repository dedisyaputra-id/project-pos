...
<div class="page-header">
    <div class="page-title">
        <h4>Tambah Detail Barang Masuk</h4>
    </div>
</div>
<div class="card">
    <div class="card-body">
        <form action="/detailbarangmasuk/simpan" method="post">
            <?php csrf_field() ?>
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="mb-3">
                        <label>Barcode</label>
                        <input type="text" name="barcode" class="form-control <?= (validation_show_error("barcode")  ? "is-invalid" : ""); ?>" value="<?= old("barcode");  ?>">
                        <div id="validationServer04Feedback" class="invalid-feedback">
