...
$routes->get("/menu/tambah", "Menu::create");
$routes->post("/menu/simpan", "Menu::save");
$routes->get("/menu/(:alphanum)", "Menu::edit/$1");
$routes->put("/menu/ubah/(:alphanum)", "Menu::update/$1");
$routes->delete("/menu/hapus/(:alphanum)", "Menu::delete/$1");
